...
TEXT: dict[str, dict[str, str]] = {
    "zh-Hans": {
        ...
        "add_files": "添加文件",
        "translate_srt": "翻译字幕",
        "translate_srt_tooltip": "打开字幕翻译指引，使用 DeepSeek 翻译生成的 SRT 文件",
        "start": "开始处理",
        "stop": "停止",
        ...
        "translation_intro": "本功能不在软件内处理翻译，而是引导你使用 DeepSeek Chat 翻译已生成的 SRT 文件。",
        "translation_steps_title": "操作步骤",
        "translation_step_open": "1. 打开 DeepSeek 官网",
        "translation_step_upload": "2. 将生成的 SRT 文件拖入网页对话框",
        "translation_step_prompt": "3. 复制并粘贴预设提示词，让 DeepSeek 按 SRT 格式翻译",
        "open_deepseek": "打开 DeepSeek 官网",
        "open_deepseek_tooltip": "在浏览器中打开 DeepSeek Chat",
        "copy_prompt": "复制提示词",
        "copy_prompt_tooltip": "复制 SRT 翻译提示词到剪贴板",
        "translation_prompt_label": "预设提示词",
        "translation_prompt_copied": "提示词已复制",
        "translation_prompt": "请翻译我上传的 SRT 字幕文件，目标语言：简体中文。\n\n要求：\n1. 保留 SRT 编号和时间轴，不能修改时间码。\n2. 只翻译字幕正文，不要翻译文件名、编号或时间戳。\n3. 保持原有分段和换行结构，输出完整 SRT。\n4. 专有名词、人名、地名不确定时保留原文或采用常见译名。\n5. 不要添加解释、总结或 Markdown，只输出翻译后的 SRT 内容。",
    ...
    "zh-Hant": {
        ...
        "add_files": "新增檔案",
        "translate_srt": "翻譯字幕",
        "translate_srt_tooltip": "開啟字幕翻譯指引，使用 DeepSeek 翻譯生成的 SRT 檔案",
        "start": "開始處理",
        "stop": "停止",
        ...
        "translation_intro": "本功能不在軟體內處理翻譯，而是引導你使用 DeepSeek Chat 翻譯已生成的 SRT 檔案。",
        "translation_steps_title": "操作步驟",
        "translation_step_open": "1. 開啟 DeepSeek 官網",
        "translation_step_upload": "2. 將生成的 SRT 檔案拖入網頁對話框",
        "translation_step_prompt": "3. 複製並貼上預設提示詞，讓 DeepSeek 按 SRT 格式翻譯",
        "open_deepseek": "開啟 DeepSeek 官網",
        "open_deepseek_tooltip": "在瀏覽器中開啟 DeepSeek Chat",
        "copy_prompt": "複製提示詞",
        "copy_prompt_tooltip": "複製 SRT 翻譯提示詞到剪貼簿",
        "translation_prompt_label": "預設提示詞",
        "translation_prompt_copied": "提示詞已複製",
        "translation_prompt": "請翻譯我上傳的 SRT 字幕檔案，目標語言：繁體中文。\n\n要求：\n1. 保留 SRT 編號和時間軸，不能修改時間碼。\n2. 只翻譯字幕正文，不要翻譯檔名、編號或時間戳。\n3. 保持原有分段和換行結構，輸出完整 SRT。\n4. 專有名詞、人名、地名不確定時保留原文或採用常見譯名。\n5. 不要添加解釋、總結或 Markdown，只輸出翻譯後的 SRT 內容。",
        "file_status_waiting": "等待",
    ...
    "en": {
        ...
        "translate_srt_tooltip": "Open a guide for translating generated SRT files with DeepSeek",
        "start": "Start",
        "stop": "Stop",
        ...
        "translation_intro": "This feature does not translate inside the app. It guides you to use DeepSeek Chat with the generated SRT file.",
        "translation_steps_title": "Steps",
        "translation_step_open": "1. Open the DeepSeek official website",
        "translation_step_upload": "2. Drag the generated SRT file into the web chat",
        "translation_step_prompt": "3. Copy and paste the preset prompt so DeepSeek preserves the SRT format",
        "open_deepseek": "Open DeepSeek",
        "open_deepseek_tooltip": "Open DeepSeek Chat in your browser",
        "copy_prompt": "Copy Prompt",
        "copy_prompt_tooltip": "Copy the SRT translation prompt to the clipboard",
        "translation_prompt_label": "Preset prompt",
        "translation_prompt_copied": "Prompt copied",
        "translation_prompt": "Please translate the uploaded SRT subtitle file into English.\n\nRequirements:\n1. Preserve SRT numbering and timestamps exactly. Do not change timecodes.\n2. Translate only subtitle text. Do not translate file names, numbering, or timestamps.\n3. Keep the original segmentation and line break structure, and output a complete SRT file.\n4. Keep proper nouns, names, and places in the original form when unsure, or use widely accepted translations.\n5. Do not add explanations, summaries, or Markdown. Output only the translated SRT content.",
