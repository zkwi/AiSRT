...
- [ ] 首次启动会按系统语言选择界面语言，手动切换后能记住用户选择。
- [ ] 简体中文、繁体中文、英语、日语、韩语、西班牙语切换正常。
...
```powershell
.\scripts\build_portable.ps1 -Version 0.1.3
```

产物应位于 `dist/release/`：

- [ ] `AiSRT-v0.1.3-windows-portable.zip`
- [ ] `aisrt-0.1.3-py3-none-any.whl`
- [ ] `SHA256SUMS.txt`
